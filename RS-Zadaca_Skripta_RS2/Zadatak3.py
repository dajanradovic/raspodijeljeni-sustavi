...
zbrojeni_bodovi = zbrojeni_bodovi = [{student["prezime"]: sum(student["bodovi"])} for student in studenti]
...
faktorijeli = {x: list(map(lambda x: math.factorial(x), range(1, x+1))) for x in range(1, 11)}
print(faktorijeli) # {1: [1], 2: [1, 2], 3: [1, 2, 6], 4: [1, 2, 6, 24], 5: [1, 2, 6, 24,120], 6: [1, 2, 6, 24, 120, 720], 7: [1, 2, 6, 24, 120, 720, 5040], 8: [1, 2, 6, 24, 120,
#  720, 5040, 40320], 9: [1, 2, 6, 24, 120, 720, 5040, 40320, 362880], 10: [1, 2, 6, 24, 120,
