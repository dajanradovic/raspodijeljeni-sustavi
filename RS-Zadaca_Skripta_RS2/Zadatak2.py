...
svi_punoljetni = all(map(lambda student: True if student['godine'] >= 18 else False, studenti))

print(svi_punoljetni) # False


# 5. Definirajte varijablu min_duljina koja će pohranjivati minimalnu duljinu riječi int . Koristeći
